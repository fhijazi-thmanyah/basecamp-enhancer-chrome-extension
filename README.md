...
> **الخصوصية:** الإضافة قد ترسل إحصاءات استخدام وتقارير أخطاء (مربوطة ببريدك في Basecamp) لمطوّر الإضافة عبر PostHog، عشان نعرف متى تصير مشاكل ونصلّحها. تقدر تطفيها في أي وقت من مفتاح **Usage analytics** في الإعدادات.
